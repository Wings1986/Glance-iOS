    ...
    if (xmlNode_ != NULL) {
        ...
        if (prefix) {
            ...
            if (foundNS) {
                ...
                return [self firstElementForLocalName:localName URI:desiredURI];
            }
        }
...
- (GDataXMLElement *)firstElementForLocalName:(NSString *)localName URI:(NSString *)URI
{
    if (xmlNode_ != NULL && xmlNode_->children != NULL) {
